<template>
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <header>
            <h2 class="text-xl font-bold text-gray-200 sm:text-3xl">Product Card Collection</h2>
        ...
        <div class="mt-4 lg:mt-8 lg:grid lg:grid-cols-4 lg:items-start lg:gap-8">
            <div class="hidden space-y-4 lg:block">
                ...
                <div>
                    <p class="block text-xs font-medium text-gray-100">Filters</p>

                    <div class="mt-1 space-y-2">
                        <details
                            class="overflow-hidden rounded border border-gray-300 [&_summary::-webkit-details-marker]:hidden">
                            <summary
                                class="flex cursor-pointer items-center justify-between gap-2 p-4 text-gray-200 transition">
                            ...
                            <div class="border-t border-gray-200 bg-gray-700">
                                ...
                                <ul class="space-y-1 border-t border-gray-200 p-4">
                                    <li>
                                        <label for="FilterInStock" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> In Stock (5+) </span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        <label for="FilterPreOrder" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Pre Order (3+) </span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        <label for="FilterOutOfStock" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Out of Stock (10+)
                                            </span>
                                        </label>
                                    </li>
                                </ul>
                                ...
                                <ul class="space-y-1 border-t border-gray-200 p-4">
                                    <li>
                                        <label for="FilterRed" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Red </span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        <label for="FilterBlue" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Blue </span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        <label for="FilterGreen" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Green </span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        <label for="FilterOrange" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Orange </span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        <label for="FilterPurple" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Purple </span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        <label for="FilterTeal" class="inline-flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-100"> Teal </span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <a href="#" class="group block overflow-hidden">
                            ...
                            <div class="relative bg-gray-700 pt-3">
                                ...
                                <p class="mt-2">
                                    ...
                                    <span class="tracking-wider text-gray-200"> £24.00 GBP </span>
                                </p>
                            </div>
                        </a>
                    </li>
