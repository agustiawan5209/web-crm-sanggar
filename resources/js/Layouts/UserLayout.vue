...
<template>
    <HomeLayout>
                                    ...
                                    <div class="flex items-center px-2 lg:px-0">
                                        ...
                                        <div class="hidden lg:ml-6 lg:block lg:space-x-4">
                                            <div class="flex">
                                                ...
                                                <a href="#"
                                                    class="hover:bg-sky-800 rounded-md py-2 px-3 text-sm font-medium text-white"
                                        ...
                                        <div class="w-full max-w-lg lg:max-w-xs">
                                            ...
                                            <div class="relative text-sky-100 focus-within:text-gray-400">
                                                ...
                                                <input id="search" name="search"
                                                    class="block w-full rounded-md border border-transparent bg-sky-700 bg-opacity-50 py-2 pl-10 pr-3 leading-5 placeholder-sky-100 focus:border-white focus:bg-white focus:text-gray-900 focus:placeholder-gray-500 focus:outline-none focus:ring-white sm:text-sm"
        ...
        Heroicon name: outline/bars-3" x-state:on="Menu open" x-state:off="Menu closed"
        ...
        Heroicon name: outline/x-mark" x-state:on="Menu open" x-state:off="Menu closed"
                                                class="hidden h-6 w-6 flex-shrink-0"
                                    ...
                                    <div class="hidden lg:ml-4 lg:block">
                                        <div class="flex items-center">
                                            ...
                                            <div x-data="Components.menu({ open: false })" x-init="init()"
                                                ...
                                                @click.away="onClickAway($event)" class="relative ml-4 flex-shrink-0">
                                                <div>
                                                    <button type="button"
                            ...
                            <div x-description="Mobile menu, show/hide based on menu state."
                                class="bg-sky-900 lg:hidden" id="mobile-menu" x-show="open">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mt-1">
                                                            <textarea id="about" name="about" rows="3"
                                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm"></textarea>
                                                        </div>
                                        ...
                                        <div class="divide-y divide-gray-200 pt-6">
                                            <div class="px-4 sm:px-6">
                                                <div>
                                                    ...
                                                    <p class="mt-1 text-sm text-gray-500">Ornare eu a volutpat eget
                                                        vulputate. Fringilla commodo amet.
                                                    </p>
                                                </div>
                                                <ul role="list" class="mt-2 divide-y divide-gray-200">
                                                    <li class="flex items-center justify-between py-4"
                                                        ...
                                                        <div class="flex flex-col">
                                                            ...
                                                            <p class="text-sm text-gray-500"
                                                                id="privacy-option-1-description">Nulla amet tempus sit
                                                    ...
                                                    <li class="flex items-center justify-between py-4"
                                                        ...
                                                        <div class="flex flex-col">
                                                            <p class="text-sm font-medium text-gray-900"
                                                                id="privacy-option-2-label">Make account private
                                                            </p>
                                                            <p class="text-sm text-gray-500"
                                                                id="privacy-option-2-description">Pharetra morbi dui mi
                                                                mattis
                                                    ...
                                                    <li class="flex items-center justify-between py-4"
                                                        ...
                                                        <div class="flex flex-col">
                                                            ...
                                                            <p class="text-sm text-gray-500"
                                                                id="privacy-option-3-description">Integer amet, nunc
                                                                hendrerit
                                                    ...
                                                    <li class="flex items-center justify-between py-4"
                                                        ...
                                                        <div class="flex flex-col">
                                                            ...
                                                            <p class="text-sm text-gray-500"
                                                                id="privacy-option-4-description">Adipiscing est
                                                                venenatis enim
