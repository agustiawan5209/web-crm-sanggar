    ...
    <main class="w-full">
        ...
        <nav class="flex bg-primary items-center relative justify-between  px-5 py-6 w-full z-50">
            ...
            <ul id="drawer" role="menu"
                ...
                <li :class="route().current('all.produk_alat') ? 'bg-white text-primary hover:bg-gray-200 ' : 'bg-primary text-white'"
                    class="font-medium border border-white rounded-md text-base p-3 cursor-pointer">
                    <Link :href="route('all.produk_alat')">Kostum Tari & Pakaian Adat</Link>
                </li>
            </ul>
            <div class="flex gap-3 items-center" v-if="auth.user">
                ...
                <div class="h-10 w-10 hover:ring-4 user cursor-pointer relative ring-blue-700/30 rounded-full bg-cover bg-center bg-[url('/img/users.png')]"
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                    ...
                    <ul class="mt-4 flex">
                                            ...
                                            <li class="ml-6">
                            <a href="https://www.instagram.com/sanggar.seni.kawali/" target="_blank" title="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    class="fill-current">
                                    <path
