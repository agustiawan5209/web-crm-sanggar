...
<template>
    <main class="w-full">
        ...
        <!-- start header -->
        <!-- component -->
        <nav class="flex dark:bg-slate-900 items-center relative justify-between bg-white px-5 py-6 w-full z-50">
            <div>
            ...
            <ul id="drawer" role="menu"
                ...
                <li
                    ...
                    <Link :href="route('all.produk_jasa')" class="dark:text-white">Jasa Tari & Pelatihan Tari</Link>
                </li>
                <li
                    ...
                    <a href="#" class="dark:text-white">Kostum Tari & Pakaian Adat</a>
                </li>
            </ul>
