...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Show Detail Customer</h2>
        </template>
                            ...
                            <div class="col-span-full  ">
                                ...
                                <table class="w-full table">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>:</td>
                                        <td class="text-sm border-b text-gray-600"> {{ customer.no_telpon }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="text-sm border-b py-2 font-bold capitalize">alamat</td>
                                        <td>:</td>
                                        <td class="text-sm border-b text-gray-600 text-left" v-html="customer.alamat"> </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
